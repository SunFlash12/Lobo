...
function fileFilter(req, file, cb) {
  if (ALLOWED_AUDIO.has(file.mimetype) || ALLOWED_IMAGE.has(file.mimetype)) return cb(null, true);
  cb(new Error('Only audio (mp3/ogg/wav) or image (png/jpg/gif/webp/svg) files are allowed.'));
}
